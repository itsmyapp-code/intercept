  ...
  return (
    <main className="max-w-2xl mx-auto py-12 px-4 text-white">
      ...
      <ul className="list-disc ml-6 my-4 space-y-2">
        <li>Strictly Necessary: Essential for security and login.</li>
        <li>Statistical/Performance: Used to improve service (Opt-out provided).</li>
        <li>Third-Party Tracking: Marketing and external scripts (Opt-in required).</li>
      </ul>
